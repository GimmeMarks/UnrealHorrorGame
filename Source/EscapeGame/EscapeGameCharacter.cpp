...
void AEscapeGameCharacter::NotifyControllerChanged()
{
...
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// SPRINTING
		EnhancedInputComponent->BindAction(SprintAction, ETriggerEvent::Started, this, &AEscapeGameCharacter::StartSprint);
		EnhancedInputComponent->BindAction(SprintAction, ETriggerEvent::Completed, this, &AEscapeGameCharacter::StopSprint);
